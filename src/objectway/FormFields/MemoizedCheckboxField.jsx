...
const MemoizedCheckboxField = memo(({ item, currentPath }) => {
...
// const MemoizedCheckboxField = memo(({ item, currentPath, isDisabled }) => {
//   const dispatch = useDispatch();
...
//         className={`focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded ${isDisabled ? 'cursor-not-allowed opacity-60' : ''}`}
//       />
//       <label htmlFor={item.id} className="ml-2 block text-sm font-medium text-gray-900">
//         {label}
//       </label>
