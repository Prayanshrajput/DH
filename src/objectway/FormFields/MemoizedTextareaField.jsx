...
// import { selectFieldValue } from '../../features/reduxSelectors'; // Adjust path

// const MemoizedTextareaField = memo(({ item, currentPath, isDisabled }) => {
//   const dispatch = useDispatch();
...
//         className={`mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${isDisabled ? 'cursor-not-allowed bg-gray-100 opacity-60' : ''}`}
//       ></textarea>
//     </div>
//   );
// });
